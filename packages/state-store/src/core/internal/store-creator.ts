...
import type { ComputedState } from '../types/internal/state';
import type { StoreConfig, StoreInternal } from '../types/internal/store';
import type { ActionsDef, AsyncActionsDef, ComputedDef } from '../types/public-types';

import { ActionManager } from './action-manager';
import { AsyncActionManager } from './async-action-manager';
...
> {
  ...
  constructor(config: StoreConfig<TState, TComputed, TActions, TAsyncActions>) {
    ...
    // 상태 관리자 초기화
    this.stateManager = new StateManager<TState, TComputed>(
