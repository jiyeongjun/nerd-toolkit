import type { AsyncResult } from '@nerd-toolkit/state-store';

import type { AsyncState } from '../core/types/internal/state';
 ...
 */
export async function unwrap<TState>(
  asyncAction: Promise<AsyncResult<TState>>,
